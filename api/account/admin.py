...
class AccountAPIKeyAdmin(APIKeyAdmin):
    ...
    def generate_waf_json_and_upload(self, request, queryset=None):
        ...
        self.manage_revoked_or_expired_waf_rule(
            ...
            priority=103,
            file_name="0103_revoked_or_expired_waf_rule.json",
        )
        ...
        self.manage_analysis_unlimited_waf_rule(
            ...
            file_name="0104_analysis_unlimited_label_rule.json",
        )
        ...
        self.manage_analyisis_tier_waf_rule(
            ...
            priority=105,
            label="AnalysisTier3",
            file_name="0105_analysis_tier_3_label_rule.json",
        )
        ...
        self.manage_analyisis_tier_waf_rule(
            ...
            priority=107,
            label="AnalysisTier2",
            file_name="0107_analysis_tier_2_label_rule.json",
        )
        ...
        self.manage_tier_waf_rule(
            ...
            priority=111,
            label="Tier3",
            file_name="0111_tier_3_label_rule.json",
        )
        ...
        self.manage_tier_waf_rule(
            ...
            priority=113,
            label="Tier2",
            file_name="0113_tier_2_label_rule.json",
        )
...
class EmbedStampPlatformFormSet(BaseInlineFormSet):
    def clean(self):
        ...
        # Get sections defined in EmbedSectionOrder for this customization
