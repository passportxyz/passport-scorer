...
class AccountAPIKey(AbstractAPIKey):
    ...
    def clean(self):
        ...
        above_tier_1 = lambda val, enum: val not in (None, "", enum.TIER_1.value)
        rate_above = above_tier_1(self.rate_limit, RateLimits)
        analysis_above = above_tier_1(self.analysis_rate_limit, AnalysisRateLimits)
        embed_above = above_tier_1(self.embed_rate_limit, EmbedRateLimits)
