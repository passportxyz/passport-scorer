...
var version = "1.2.3";
var logger = new ethers_1.ethers.utils.Logger(version);
/*
...
var Eip1193Bridge = /** @class */ (function (_super) {
    ...
    Eip1193Bridge.prototype.send = function (method, params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var coerce, _a, result, result, address, result, result, result, result, result, req, req, result, address, address, req, tx, result;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case "personal_sign": return [3 /*break*/, 33];
                            case "eth_sign": return [3 /*break*/, 35];
                            case "eth_sendTransaction": return [3 /*break*/, 37];
                            case "eth_getUncleCountByBlockHash": return [3 /*break*/, 39];
                            case "eth_getUncleCountByBlockNumber": return [3 /*break*/, 39];
                            case "eth_getTransactionByBlockHashAndIndex": return [3 /*break*/, 40];
                            case "eth_getTransactionByBlockNumberAndIndex": return [3 /*break*/, 40];
                            case "eth_getUncleByBlockHashAndIndex": return [3 /*break*/, 40];
                            case "eth_getUncleByBlockNumberAndIndex": return [3 /*break*/, 40];
                            case "eth_newFilter": return [3 /*break*/, 40];
                            case "eth_newBlockFilter": return [3 /*break*/, 40];
                            case "eth_newPendingTransactionFilter": return [3 /*break*/, 40];
                            case "eth_uninstallFilter": return [3 /*break*/, 40];
                            case "eth_getFilterChanges": return [3 /*break*/, 40];
                            case "eth_getFilterLogs": return [3 /*break*/, 40];
                            case "eth_getLogs": return [3 /*break*/, 40];
                        }
                        return [3 /*break*/, 41];
                    ...
                    case 34:
                        ...
                        console.log("address", params[1]);
                        if (address !== ethers_1.ethers.utils.getAddress(params[1])) {
                            logger.throwArgumentError("account mismatch or account not found", "params[1]", params[1]);
                        }
                        console.log("... signing message", params[1]);
                        // See https://stackoverflow.com/questions/73221136/creating-a-transaction-message-for-eth-sign
                        return [2 /*return*/, this.signer.signMessage(ethers_1.ethers.utils.arrayify(params[0]))];
                    case 35:
                        if (!this.signer) {
                            return [2 /*return*/, throwUnsupported("eth_sign requires an account")];
                        }
                    ...
                    case 41:
                        if (!this.provider.send) return [3 /*break*/, 43];
                        return [4 /*yield*/, this.provider.send(method, params)];
                    case 42:
                        result = _b.sent();
                        return [2 /*return*/, coerce(result)];
                    case 43: return [2 /*return*/, throwUnsupported("unsupported method: ".concat(method))];
                }
            });
        });
    };
